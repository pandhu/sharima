...
function zerif_scripts()
{
    ...
    //pawp_enqueue_style( 'zerif_font_all', '//fonts.googleapis.com/css?family=Open+Sans:400,300,300italic,400italic,600italic,600,700,700italic,800,800italic');
    
    wp_enqueue_style('bootstrap', get_template_directory_uri() . '/css/bootstrap.css');
    wp_enqueue_style('icons-fonts', get_template_directory_uri() . '/css/icons-fonts.css');
    ...
    wp_enqueue_style('rs-plugin-setting', get_template_directory_uri() . '/css/rs-plugin/settings.css');
    wp_enqueue_style('rs-custom', get_template_directory_uri() . '/css/revo-slider/custom.css');
    ...
    wp_enqueue_script('magnific-popup', get_template_directory_uri() . '/js/jquery.magnific-popup.js', array(), '20120206', true);
    wp_enqueue_script('wow', get_template_directory_uri() . '/js/wow.min.js', array(), '20120206', true);
    wp_enqueue_script('main', get_template_directory_uri() . '/js/main.js', array(), '20120206', true);
    wp_enqueue_script('rs-tools', get_template_directory_uri() . '/js/rs-plugin/jquery.themepunch.tools.min.js', array(), '20120206', true);
    wp_enqueue_script('rs-custom', get_template_directory_uri() . '/js/rs-plugin/jquery.themepunch.revolution-custom.min.js', array(), '20120206', true);
    wp_enqueue_script('owl-carousel', get_template_directory_uri() . '/js/owl-carousel/owl.carousel.min.js', array(), '20120206', true);
